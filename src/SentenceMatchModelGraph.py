                ...
                if prediction_mode != 'point_wise':
                    ...
                    if prediction_mode == 'list_wise':
                        ...
                        if new_list_wise == False:
                            ...
                            neg_count = tf.reduce_sum(neg_mask, axis=1) #[q]
                            ...
                            pos_exp = tf.multiply(pos_exp, pos_mask)
                            ...
                            if pos_avg == True:
                                ...
                                fi += modify_loss * (tf.maximum(0.0, -tf.divide(tf.multiply(logits, pos_mask), tf.reduce_sum(pos_mask)))
                                                     + tf.maximum(0.0, tf.div(tf.multiply(logits, neg_mask), tf.reduce_sum(neg_mask))))
